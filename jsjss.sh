...
java $JAVA_OPTS -classpath $CLASSPATH -Djs.url=service:jmx:remote+http://$HOST:9990 -Djs.host=localhost:1090 -Djs.base=jmxconnector -Djs.username=wozza -Djs.password=wozza RunScript $@
