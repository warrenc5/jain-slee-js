...
mvn -Dshade.skip=true -Pshade,run -U -Dexecutable=`which java` -Dmaven.test.skip -Djs.debug=true -Djs.trace=true -Djs.username=admin -Djs.password=admin -Djs.host=${IP} -Djs.script=src/test/js/usage.js
